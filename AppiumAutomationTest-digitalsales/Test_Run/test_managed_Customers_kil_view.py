...
from Managed_Customers_kil.test_customer_list_view import test_verify_customer_list_elements,test_verify_filter_result_count_sequentially, test_verify_filter_results_sequentially
from Managed_Customers_kil.test_recommended_product_settings import test_navigate_to_recommended_product_settings
...
def test_managed_customers_kil_view_run(flow_tester, sheets_service, tester_name):
    ...
    try:
        ...
        content_unit_passed, content_unit_message = test_verify_filter_results_sequentially(flow_tester)

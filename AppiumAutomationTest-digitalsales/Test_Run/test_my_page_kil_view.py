...
from My_Page_kil.test_my_page_entry import test_my_page_button_visibility,test_my_page_navigation
...
def test_my_page_kil_view_run(flow_tester, sheets_service, tester_name):
    ...
    try:
        ...
        content_unit_passed, content_unit_message = test_my_page_navigation(flow_tester)
